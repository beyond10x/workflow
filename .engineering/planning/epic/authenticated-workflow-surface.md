...
id: epic:authenticated-workflow-surface
kind: epic
status: draft
title: Authenticated workflow service surface
summary: Expose tenant-scoped HTTP, OpenAPI, docs, and service integration boundaries.
relations:
