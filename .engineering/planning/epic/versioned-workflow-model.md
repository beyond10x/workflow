...
id: epic:versioned-workflow-model
kind: epic
status: draft
title: Versioned workflow model and compatibility
summary: Own workflow definitions and preserve useful predecessor API semantics explicitly.
relations:
