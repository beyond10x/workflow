...
id: story:trigger-delivery
kind: story
status: draft
title: Schedule and webhook trigger delivery
summary: Converge every trigger on the same idempotent run admission path.
relations:
- derived_from: epic:durable-workflow-execution
- depends_on: story:durable-run-admission
- serves: vision:O5
revision: 1
---
