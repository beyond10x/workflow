...
id: story:connector-backed-steps
kind: story
status: draft
title: Connector-backed workflow steps
summary: Resolve and invoke granted Connector capabilities without storing credential bytes.
relations:
- derived_from: epic:authenticated-workflow-surface
- depends_on: story:identity-authority-client
- serves: vision:O1
- serves: vision:O5
revision: 1
---
