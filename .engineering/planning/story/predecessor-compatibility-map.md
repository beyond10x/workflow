...
id: story:predecessor-compatibility-map
kind: story
status: draft
title: Predecessor compatibility map
summary: Map adopted legacy API semantics onto the new versioned contract without runtime coupling.
relations:
